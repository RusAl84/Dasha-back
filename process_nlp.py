...
def data_proc(filename, save_filename, threshold=0):
    ...
    for m in messages:
        text = m["text"]
        print(
            f"{num / count_messages * 100}     {count_messages-num}     {num} / {count_messages}")
        num += 1
...
def find_data(save_filename, find_text, save_score_filename="./lt_find_data_proc.json", threshold=0, fuzz=1):
...
if __name__ == '__main__':
    ...
    save_score_filename = "./lt_find_data_proc.json"
    # data_proc(filename, save_filename, 32)
    s = find_data(save_filename, find_text,
                  save_score_filename="./lt_find_data_proc.json", threshold=0, fuzz=3)
    print(s)
    # s1 = """
